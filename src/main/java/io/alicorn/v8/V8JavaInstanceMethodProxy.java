    ...
    public JavaCallback getCallbackForInstance(final Object o) {
        return new JavaCallback() {
            @Override public Object invoke(V8Object receiver, V8Array parameters) {
            	...
            	return callMethodProxy(o, receiver, parameters, getMethodName(), getMethodSignatures(), cache);
            }
        };
    }
    
    public static Object callMethodProxy(Object o, V8Object receiver, V8Array parameters, String methodName, List<Method> methodSignatures, V8JavaCache cache) {
    	Object[] coercedArguments = null;
        Method coercedMethod = null;
        IllegalArgumentException argumentsMismatchException = null;
        for (Method method : methodSignatures) {
            try {
